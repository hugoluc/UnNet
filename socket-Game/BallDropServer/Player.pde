...
public class Player {  
  ...
  public void movePaddle(float howMuch) {
    ...
    println("moving paddle by: ", howMuch);
    println("paddle was in:", paddleH);
    ...
    println("and now should be:", paddleH);
  }
  ...
  public void showPaddle() {
    ...
    println("-------------------Drawing Paddle ", paddleVelocity);

    fill(paddleColor);
    rect(paddleH, paddleV+paddleHeight, 3, 10);
